    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=1, verbose_name="Duration (days)"
                    ),
                ),
                (
                    "max_people",
                    models.PositiveIntegerField(default=10, verbose_name="Max People"),
                ),
                (
                    "inclusions",
                    models.TextField(
            ...
            options={
                ...
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["slug"], name="packages_pa_slug_a25c8d_idx"),
                    models.Index(
                        fields=["published", "available", "-created_at"],
                        name="packages_pa_publish_c3a890_idx",
                    ),
                ],
            },
        ),
